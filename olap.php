            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="auth">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="pages/jumlah-pembelian/kota-jumlah.php">
                                    Berdasarkan Vendor</a></li>
                            <li class="nav-item"> <a class="nav-link" href="pages/jumlah-pembelian/tahun-jumlah.php">
                                    Berdasarkan Tahun </a></li>
                        </ul>
                    </div>
                </li>
        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> OLAP DW Adventure </h3>
                </div>
                <div class="row">
                    <!-- Begin Page Content -->
                    <p class="highcharts-description text-white" style="font-size:18px; text-align:center;">
                        Berikut merupakan tampilan OLAP dari DW Adventure yang di integrasikan dengan Mondrian.
                    </p>
                    <!-- /.container-fluid -->
                    <br>
                    ...
                    <footer class="footer">
                        <div class="d-sm-flex justify-content-center justify-content-sm-between">
                            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©
                                Kelompok 3 DW Adventure 2023</span>
                        </div>
                    </footer>
                    <!-- partial -->
                </div>

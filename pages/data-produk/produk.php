            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"> <br>
                        Berikut merupakan grafik untuk menampilkan total penjualan dari produk kategori yang terjual. Produk kategori
                        yang banyak terjual berasal dari kategori Bikes dengan total penjualan $3578.3
                    </p>
                    ...
                    Highcharts.chart('barchart', {
                        ...
                        title: {
                            text: 'Data Produk Kategori Yang Terjual'
                        },
                        subtitle: {

...
<head>
    ...
    <title>Dashboard DW Adventure</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <p class="highcharts-description">
                    Berikut merupakan grafik untuk menampilkan pengiriman dari setiap Metode Pengiriman.
                </p>
                <!-- /.container-fluid -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Dashboard DW Adventure</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->

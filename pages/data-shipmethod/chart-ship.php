            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"><br>
                        Berikut merupakan grafik untuk menampilkan total pembelian berdasarkan metode pengiriman barang yang digunakan.
                        Pengiriman yang sering digunakan yaitu Cargo Transport 5 dengan total pembelian sebanyak $650.0.
                    </p>
                    ...
                    Highcharts.chart('barchart', {
                        ...
                        subtitle: {
                            text: 'Source: Database DWAdventure'
                        },
                        accessibility: {
                            announceNewData: {
                                enabled: true
                        ...
                        yAxis: {
                            title: {
                                text: 'Total Pembelian Pengiriman'
                            }

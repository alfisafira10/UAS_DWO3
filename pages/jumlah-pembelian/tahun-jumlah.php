        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Data Total Pembelian Berdasarkan Tahun </h3>
                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px; text-align:center;"><br>
                        Berikut merupakan grafik untuk menampilkan total pembelian produk per-tahun. Total Pembelian produk
                        terbanyak berasal dari tahun 2011.
                    </p>

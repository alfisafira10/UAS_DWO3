        ...
        <div class="container-fixed page-body-wrapper">
            <div class="content-wrapper">
                <div class="page-header">
                    <h3 class="page-title" style="font-size:20px;"> <br> Total Penjualan Berdasarkan Tahun </h3>

                </div>
                <div class="row">
                    <div id="barchart" class="grafik"></div>
                    <p class="highcharts-description" style="font-size:14px;text-align:center;"><br>
                        Berikut merupakan grafik untuk menampilkan data total penjualan berdasarkan tahun. Total
                        penjualan terbanyak berasal dari tahun 2012, 2011, dan disusul tahun 2013. Kemudian, pada 
                        tahun 2014 total penjualan mengalami penurunan yang cukup drastis.
                    </p>
                    ...
                    Highcharts.chart('barchart', {
                        ...
                        title: {
                            text: 'Data Total Penjualan Per-Tahun'
                        },
                        subtitle: {
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright ©
                            Kelompok 3 DWAdventure 2022</span>
                    </div>
                </footer>
            </div>
        </div>
